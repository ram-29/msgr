...
/**
 * ThreadMessageSearch represents the model behind the search form of `common\models\ThreadMessage`.
 */
class ThreadMessageSearch extends ThreadMessage
{
    /**
     * @inheritdoc
     */
